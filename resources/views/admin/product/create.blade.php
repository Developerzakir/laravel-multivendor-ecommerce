					...
					<div class="form-body mt-4">
						...
						<div class="border border-3 p-4 rounded">
							...
							<div class="form-group mb-3">
								...
								<textarea id="mytextarea" class="form-control" name="long_descp">Hello, World!</textarea>
							</div>
							<div class="form-group mb-3">
...
<!--Thumbnail image & Multi image preview before insert -->
...
<script> 
 ...
 <!--Subcategory display js code based on category select -->
<script type="text/javascript">
		$(document).ready(function(){
...
<!--Add product all field validation with javascript -->
<script type="text/javascript">
    $(document).ready(function (){
        $('#myForm').validate({
            rules: {
