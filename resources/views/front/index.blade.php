...
@include('front.inc.top-slider')
<!--End hero slider-->
@include('front.inc.featured-category')
<!--End category slider-->
                    ...
                    <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                        <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
                            ...
                            <div class="product-content-wrap">
                                ...
                                <h2><a href="shop-product-right.html"><a href="{{ url('product/details/'.$product->id.'/'.$product->product_slug) }}"> {{ $product->product_name }} </a></h2>
...
<!--Vendor List start -->
@include('front.inc.home_vendor_list')
<!--End Vendor List -->
