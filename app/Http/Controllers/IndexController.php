...
class IndexController extends Controller
{
    public function index()
    {
        ...
        return view('front.index',compact('skip_category_0','skip_product_0','skip_category_2','skip_product_2','skip_category_7','skip_product_7','hot_deals','special_offer','new','special_deals'));
    ...
    public function ProductDetails($id,$slug)
    {
     ...
     public function VendorDetails($id)
     {
        ...
        return view('front.vendor.vendor_details',compact('vendor','vproduct'));
     } // End Method 

     public function VendorAll()
     {
     $vendors = User::where('status','active')->where('role','vendor')->orderBy('id','DESC')->get();
        return view('front.vendor.vendor_all',compact('vendors'));
     } // End Method 
}
